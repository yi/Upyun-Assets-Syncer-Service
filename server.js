...
(function() {
  var CMD_SYNC_AMF, CMD_SYNC_GRAPHICS, CMD_SYNC_TIMESTAMPE, CURRENT_JOB, JOB_SYNC_AMF, JOB_SYNC_GRAPHICS, JOB_SYNC_TIMESTAMP, KV_CLIENTS, PATH_TO_CONFIG_FOLDER, PATH_TO_SYNCER, REG_FILTER_AMF, REG_FILTER_GRAPHICS, REG_FILTER_TIMESTAMP, TEMPLATE_JOB, app, child_process, env, fs, io, logger, runJob, server, util;
  ...
  runJob = function(regexpFilter, revisionSensitive) {
    var content, error, pathToSyncJobJson;
